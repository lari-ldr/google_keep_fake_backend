...
-- insert into notesconfigs (note_id, background_color, is_archived, is_pinned, labels)
-- values ( 1, '#f28b82', false, false, ARRAY ['comida', 'receitas', 'Supermercado']);

-- insert into notesconfigs (note_id, background_color, is_archived, is_pinned, labels)
-- values ( 2, 'pink', false, true, ARRAY ['comida', 'receitas', 'Supermercado']);
